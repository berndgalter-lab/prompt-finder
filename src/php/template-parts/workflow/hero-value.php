...
<section class="pf-hero-value pf-hero-value--modern" role="region" aria-label="Workflow Value Proposition">
    <div class="pf-hero-value-inner">
        
        <!-- ========================================
             MODERN SAAS HERO (2025 Best Practice)
             ======================================== -->
        
        <!-- Context Badge (Dezent, ohne FREE) -->
        <div class="pf-hero-context-badge-modern">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>
                <polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline>
                <line x1="12" y1="22.08" x2="12" y2="12"></line>
            </svg>
            <span>Ready-to-Use AI Workflow</span>
        </div>
        
        <!-- Headline -->
        <?php if ($tagline): ?>
            <h2 class="pf-hero-headline-modern"><?php echo esc_html($tagline); ?></h2>
        <?php endif; ?>
        
        <!-- Expected Outcome -->
        <?php if ($expected_outcome): ?>
            <p class="pf-hero-outcome-modern">
                <?php echo esc_html($expected_outcome); ?>
            </p>
        <?php endif; ?>
        
        <!-- Meta Bar (Steps, Time, Access, Trust) -->
        <div class="pf-hero-meta-bar">
            <!-- Left: Workflow Meta -->
            <div class="pf-hero-meta-chips">
                <?php if ($step_count > 0): ?>
                ...
                <span class="pf-meta-chip pf-meta-chip--<?php echo esc_attr($access_mode); ?>">
            ...
            <div class="pf-hero-trust-inline">
                <span class="pf-trust-label-inline">Works with</span>
                <span class="pf-trust-badge-inline">
        ...
        <!-- Inline Stepper (Kompakt, Modern) -->
        <div class="pf-hero-stepper">
            <span class="pf-stepper-item">
                <span class="pf-stepper-num">1</span>
                Fill variables
            </span>
            <svg class="pf-stepper-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="9 18 15 12 9 6"></polyline>
            </svg>
            <span class="pf-stepper-item">
                <span class="pf-stepper-num">2</span>
                Copy prompt
            </span>
            <svg class="pf-stepper-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="9 18 15 12 9 6"></polyline>
            ...
            <span class="pf-stepper-item">
                <span class="pf-stepper-num">3</span>
                Use in ChatGPT
            </span>
        </div>

        <!-- Old Trust Row removed - now inline in Meta Bar above -->
